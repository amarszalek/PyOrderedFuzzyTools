...
static char obj_func_ar_cml_docstring[] = "Calculate objective function (cml) for auto-regressive.";
...
static PyObject *objective_obj_func_ar_cml(PyObject *self, PyObject *args);
...
static PyMethodDef module_methods[] = {
    ...
    {"obj_func_ar_cml", objective_obj_func_ar_cml, METH_VARARGS, obj_func_ar_cml_docstring},
    {NULL, NULL, 0, NULL}
};
...
static PyObject *objective_obj_func_ar_cml(PyObject *self, PyObject *args)
{
    ...
    /* Call the external C function to compute the chi-squared. */
    double error = obj_func_ar_cml(p, np, ofns, nc, n_coef, dim2, intercept, g, ng);
